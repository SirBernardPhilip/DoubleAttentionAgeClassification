...
path_net = "/home/usuaris/veu/david.linde/DoubleAttentionSpeakerVerification/scripts/models/ca_es_en/resnet_resnet_1.0_128batchSize_0.0001lr_0.001weightDecay_512kernel_400embSize_30.0s_0.4m_DoubleMHA_32_205000.chkpt"
...
if __name__=="__main__":
    ...
    parser.add_argument('--criterion2', type=str, default='CrossEntropy',choices=['CrossEntropy','CrossEntropyWeighted','OrdinalReg','OrdinalRegWeighted','OrdinalTunedReg'] ,help='Use of weighted loss (weights imported from dicts.py, they are optimized weighted, no_weighted, weighted_train')
