...
from data import *
from model_sigmoid import SpeakerClassifier
from loss import *
from utils import *


wandb.init(project="Ordinal", entity="davilin")
...
class Trainer:
    ...
    def __load_criterion(self):
        ...
        print("Loss function: {}".format(self.params.criterion))
    ...
    def __validate(self):
        ...
        with torch.no_grad():
            ...
            for input, labels in self.validation_generator:
                ...
                prediction = prediction2prediction(prediction)
...
if __name__=="__main__":
    ...
    parser.add_argument('--criterion', type=str, default='CrossEntropy',choices=['CrossEntropy','CrossEntropyWeighted','OrdinalReg','OrdinalRegWeighted'] ,help='Use of weighted loss (weights imported from dicts.py, they are optimized weighted, no_weighted, weighted_train')
